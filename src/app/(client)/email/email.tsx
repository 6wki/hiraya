...
import banner from "/public/bannerHijab.png";
      ...
      <Container style={container}>
        ...
        <Section style={message}>
          ...
          <Text style={{ ...global.text, marginTop: 24 }}>
            ...
            please visit your Orders page on hiraya.de or in the Nike app.
          </Text>
        </Section>
        <Hr style={global.hr} />
        <Section style={global.defaultPadding}>
          <Text style={adressTitle}>Shipping to: Blerona Murseli</Text>
          <Text style={{ ...global.text, fontSize: 14 }}>munich</Text>
        </Section>
        <Hr style={global.hr} />
        <Section
        ...
        <Section style={paddingY}>
          <Text style={global.heading}>Hiraya.de</Text>
          <Row style={categories.container}>
            <Column align="center">
              <Link
                target="_blank"
                href="https://www.alhiraya.de/abaya"
            ...
            <Column align="center">
              <Link
                target="_blank"
                href="https://www.alhiraya.de/khimar"
                style={categories.text}
              >
                Khimar
              </Link>
            ...
            <Column align="center">
              <Link
                target="_blank"
                href="https://www.alhiraya.de/jilbab"
                style={categories.text}
              >
                Jilbab
              </Link>
        ...
        <Section style={paddingY}>
          ...
          <Text style={footer.text}>
            Hiraya, INC. One Bowerman Drive, Beaverton, Oregon 97005, USA.
          </Text>
        </Section>
      </Container>
    </Body>
